import { NewCardMeta, NewDigimonMeta } from "./schemas";
...
export declare const registerNewCard: <LocalState = undefined>(meta: {
    id: string;
    type: CardType;
    name: string;
    colors: [import("./enums").CardColor, ...import("./enums").CardColor[]];
} & LocalStateMeta<LocalState>, script: CardScript<{
    id: string;
    type: CardType;
    name: string;
    colors: [import("./enums").CardColor, ...import("./enums").CardColor[]];
}, LocalState>) => CardDefinition<{
    id: string;
    type: CardType;
    name: string;
    colors: [import("./enums").CardColor, ...import("./enums").CardColor[]];
} & LocalStateMeta<LocalState>, LocalState>;
export declare const registerNewDigimon: <LocalState = undefined>(meta: Omit<{
    id: string;
    type: CardType;
    name: string;
    colors: [import("./enums").CardColor, ...import("./enums").CardColor[]];
...
}, "type"> & LocalStateMeta<LocalState>, script: CardScript<{
    id: string;
    type: CardType;
    name: string;
    colors: [import("./enums").CardColor, ...import("./enums").CardColor[]];
